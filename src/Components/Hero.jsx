...
const Hero = () => {
  return (
    <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
     <div className={`flex flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 `}>
        ...
        <div className='flex text-white flex-row justify-between items-center w-full'>
          <h1 className='flex-1 font-poppins font-semibold
             text-[52px] ss:text-[72px] ss:leading-[100px]
            leading-[75px]'>
        ...
        <h1  className='font-poppins font-semibold
             text-[52px] ss:text-[68px] ss:leading-[100px]
            leading-[75px] w-full text-white'>
          Payment Method
        </h1>
        <p className={`${styles.paragraph} max-w-[470px]`}>
          Our Teams of experts uses a methodology 
          to identify the credit cards most likely 
          to fit your needs. we examine annual 
          percentsge rates, annual fees.
        </p>
     </div>
     ...
     <div className='absolute z-[0] w-[40%] h-[80%] bottom-40 white__gradient'/>
     <div className='absolute z-[1] w-[40%] h-[50%] right-20 blue__gradient'/>
     </div>
